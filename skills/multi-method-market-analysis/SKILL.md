...
1. Ask the user for their **Study Topic** and **geographic focus** (Global or specific region).
...
- `{my business}`: What is the user's company or product?
- `{my job to be done or niche}`: What market/niche should be analyzed?
