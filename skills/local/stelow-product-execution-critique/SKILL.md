...
- **stelow-product-plan-critique**: Pre-implementation critique (use before coding, complements this post-implementation audit)
- **stelow-product-testing-execution**: Post-implementation testing protocol (runs before this audit)
- **stelow-product-scope-executor**: Routes plan scopes to execution (feeds this audit's input)
