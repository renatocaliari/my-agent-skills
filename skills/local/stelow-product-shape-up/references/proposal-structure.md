...
|------|-------------|--------------------------|
| `software` | Codebase product (web, mobile, CLI, library) | ✅ Yes — stelow-product-testing-ai-code |
| `service` | Consulting, managed, or operational service | ❌ No |
| `hybrid` | Service + software components | ✅ Yes — stelow-product-testing-ai-code |
